...
@Column(name="LaravelId")
private String laravelId;
@Column(name="Image")
...
public Laravel(@NotEmpty(message = "Nhập mã Khoá Học!") String laravelId, String image,
...
public void setLaravelId(String laravelId) {
	this.laravelId = laravelId;
}
