                  ...
                  <div class="navbar-container container-fluid">
                      ...
                      <ul class="nav-right">
                          ...
                          <li class="user-profile header-notification">
                              <a href="#!" class="waves-effect waves-light">
                                  <img src="resources/assets/images/img6.jpg.jpg" class="img-radius" alt="User-Profile-Image">
                                  <span>Huy Thọ</span>
                      ...
                      <div class="pcoded-inner-navbar main-menu">
                          <div class="">
                              <div class="main-menu-header">
                                  <img class="img-80 img-radius" src="resources/assets/images/img6.jpg.jpg" alt="User-Profile-Image">
