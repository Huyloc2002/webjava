...
<body>
							...
							<li class="header-notification"><a href="#!"
								...
								<ul class="show-notification">
									...
									<li class="waves-effect waves-light">
										<div class="media">
											<img class="d-flex align-self-center img-radius"
												src="resources/assets/images/avatar-4.jpg"
												alt="Generic placeholder image">
											<div class="media-body">
					...
					<nav class="pcoded-navbar">
						...
						<div class="pcoded-inner-navbar main-menu">
							...
							<div class="pcoded-navigation-label"
								data-i18n="nav.category.navigation">Đăng Xuất</div>
							<ul class="pcoded-item pcoded-left-item">
								<li class="active"><a href="admin"
									class="waves-effect waves-dark"> <span class="pcoded-micon"><i
											class="ti-home"></i><b>D</b></span> <span class="pcoded-mtext"
										data-i18n="nav.dash.main">Danh mục Khoá Học</span> <span
										class="pcoded-mcaret"></span>
								</a></li>
								<li class="pcoded-hasmenu"><a href="javascript:void(0)"
									class="waves-effect waves-dark"> <span class="pcoded-micon"><i
											class="ti-layout-grid2-alt"></i></span> <span class="pcoded-mtext"
										data-i18n="nav.basic-components.main">Khoá Học</span> <span
										class="pcoded-mcaret"></span>
								</a>
									<ul class="pcoded-submenu">
										<li class=" "><a href="course1"
											class="waves-effect waves-dark"> <span
												class="pcoded-micon"><i class="ti-angle-right"></i></span> <span
												class="pcoded-mtext" data-i18n="nav.basic-components.alert">Tất
													cả Khoá Học</span> <span class="pcoded-mcaret"></span>
										</a></li>
										<li class=" "><a href="initInsertCourse"
											class="waves-effect waves-dark"> <span
												class="pcoded-micon"><i class="ti-angle-right"></i></span> <span
												class="pcoded-mtext"
												data-i18n="nav.basic-components.breadcrumbs">Thêm Mới
													Khóa Học</span> <span class="pcoded-mcaret"></span>
										</a></li>
								...
								<li class="pcoded-hasmenu"><a href="javascript:void(0)"
									class="waves-effect waves-dark"> <span class="pcoded-micon"><i
											class="ti-layout-grid2-alt"></i></span> <span class="pcoded-mtext"
										data-i18n="nav.basic-components.main">Lộ Trình Học</span> <span
										class="pcoded-mcaret"></span>
								</a>
									<ul class="pcoded-submenu">
										<li class=" "><a href="accordion.html"
											class="waves-effect waves-dark"> <span
												class="pcoded-micon"><i class="ti-angle-right"></i></span> <span
												class="pcoded-mtext" data-i18n="nav.basic-components.alert">Tất
													Cả Lộ Trình</span> <span class="pcoded-mcaret"></span>
										</a></li>
										<li class=" "><a href="breadcrumb.html"
											class="waves-effect waves-dark"> <span
												...
												class="pcoded-mtext"
												data-i18n="nav.basic-components.breadcrumbs">Thêm Mới
													Lộ Trình</span> <span class="pcoded-mcaret"></span>
										</a></li>
							...
							<div class="col-sm-12">
								<div class="card">
									<div class="card-header">
										<h5>Thêm Mới Danh Mục Khóa Học</h5>
									</div>
									<div class="page-body">
										...
										<form:form action="insertStudents" modelAttribute="s"
											method="post" enctype="multipart/form-data">
											<div class="row">
												<div class="col-md-6">
													<div class="form-group form-default">
														<label class="float-label">Tên:</label> <input type="text"
															name="studentName" class="form-control"> <span
															class="form-bar"></span>
															<form:errors path="studentName" cssClass="error"></form:errors>
													</div>
													<div class="form-group form-default">
														<label class="float-label">Ảnh:</label> <input type="file"
															name="imgUrl" class="form-control"> <span
															class="form-bar"></span>
																											</div>
													<div class="form-group form-default">
														<label class="float-label">Gới Tính:</label><br>
														<form:radiobutton path="gender" value="true" />
														nam
														<form:radiobutton path="gender" value="false" />
														Nữ <span class="form-bar"></span><br>
														<form:errors path="gender" cssClass="error"></form:errors>
													</div>
													<div class="form-group form-default">
														<label class="float-label">Email:</label> <input
															type="text" name="email" class="form-control"> <span
															class="form-bar"></span>
												...
												<div class="col-md-6">
													...
													<div class="form-group form-default">
														<label class="float-label">Số Điện Thoại:</label> <input
														...
														<div class="form-group form-default">
														<label class="float-label">Ngày đăng kí:</label> <input
															type="date" name="dateregistration" class="form-control">
														<span class="form-bar"></span>
															<form:errors path="dateofBirth" cssClass="error"></form:errors>
													</div>
													<div class="form-group">
														<label>Khóa Học:</label><br>
														<form:select class="form-control" path="course.couId">
															<form:options items="${listClas}" itemLabel="courseName"
																itemValue="couId" />
														</form:select>
														<form:errors path="course.couId" cssClass="error"></form:errors>
													</div>
													<button type="submit" class="btn  btn-primary mb-2">Thêm
														Mới</button>
	...
	<script type="text/javascript"
		src="resources/assets/pages/widget/excanvas.js "></script>
	<!-- waves js -->
	...
	<!-- Chart js -->
	<script type="text/javascript"
		src="resources/assets/js/chart.js/Chart.js"></script>
	<!-- amchart js -->
