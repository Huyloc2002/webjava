			...
			<div class="container">
				...
				<div class="row course_boxes">
					...
					<div class="col-lg-3 course_box">
						<div class="card">
							<img class="card-img-top" src="resources/images/course_4.jpg"
								alt="https://unsplash.com/@kellitungay">
							<div class="card-body text-center">
								<div class="card-title">
									<a href="courses.html">Bắt Đầu với PHP, LARAVEL</a>
								</div>
							...
							<div>
								<a class="btn btn-success" href="dkonline3">Đăng Kí học</a>
							</div>
						</div>
					</div>
					<div class="col-lg-3 course_box" style="color: black;">
						Laravel là một trong những framework web PHP phổ biến nhất và được
						ưa chuộng nhất hiện nay. Với sự phát triển nhanh chóng và tính
						năng đa dạng, Laravel đã trở thành một trong những lựa chọn hàng
						đầu của các nhà phát triển ứng dụng web trên toàn thế giới. Trong
						bài viết này, chúng ta sẽ tìm hiểu thêm về Laravel và tại sao nó
						lại được coi là một trong những framework web PHP tốt nhất hiện
						nay. Chúng ta sẽ khám phá các tính năng và lợi ích của Laravel
						cũng như cách sử dụng framework này để xây dựng các ứng dụng web
						chất lượng cao.</div>
