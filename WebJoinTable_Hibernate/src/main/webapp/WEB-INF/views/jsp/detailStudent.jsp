										...
										<div class="col-md-6">
											<table>
												<tr>
													...
													<td><img style="width: 300px;" src="<c:url value="resources"/>/images/${s.image}" /></td>
												</tr>
											</table>
										</div>
										<div class="col-md-6">
											<table style="width: 100%;" border="2">
												...
												<tr style="color: black; height: 50px; text-align: center;">
													<td>Tên Đăng Kí:</td>
													<td>${s.studentName }</td>
												</tr>
											...
											<a href="admin" style="margin-left: 180px; margin-top: 10px;" class="btn btn-secondary">Back</a>
