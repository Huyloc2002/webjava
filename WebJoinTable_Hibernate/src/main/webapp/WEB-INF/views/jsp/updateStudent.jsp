							...
							<div class="col-sm-12">
								<div class="card">
									...
									<div class="page-body">
										...
										<form:form action="updateStudent" modelAttribute="s"
											method="post" enctype="multipart/form-data">
											<div class="row">
												<div class="col-md-6">
													<div class="form-group form-default">
														<label class="float-label">Mã Người Dùng:</label>
													...
													<div class="form-group form-default">
														<label class="float-label">Ảnh:</label> <input type="file"
															...
															class="form-bar"></span> <img style="width: 50px"
															src="<c:url value="resources" />/images/${s.image}" />
													</div>
													<div class="form-group form-default">
												...
												<div class="col-md-6">
													...
													<div class="form-group form-default">
														<label class="float-label">Quê Quán:</label>
