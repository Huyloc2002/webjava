							...
							<div class="col-sm-12">
								<div class="card">
									...
									<div class="page-body">
										...
										<form:form action="insertCourse" modelAttribute="c"
											method="post" enctype="multipart/form-data">
											<div class="row">
												<div class="col-md-6">
													<div class="form-group form-default">
														<label class="float-label">Mã Khóa Học</label> <input
															type="text" name="couId" class="form-control"> <span
															class="form-bar"></span>
														<form:errors path="couId" cssClass="error"></form:errors>
														<br>
													</div>
													<div class="form-group form-default">
												...
												<div class="col-md-6">
													...
													<div class="form-group form-default">
														...
														<textarea class="form-control" name="courseText"></textarea>
														<span class="form-bar"></span>
														<form:errors path="courseText" cssClass="error"></form:errors>
														<br>
													</div>
