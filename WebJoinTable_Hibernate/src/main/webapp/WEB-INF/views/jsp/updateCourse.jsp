<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
      ...
      <![endif]-->
                    ...
                    <!-- waves.css -->
                    <link rel="stylesheet" href="resources/assets/pages/waves/css/waves.min.css" type="text/css"
                        media="all">
                    <!-- Required Fremwork -->
                            ...
                            <nav class="navbar header-navbar pcoded-header">
                                <div class="navbar-wrapper">
                                    <div class="navbar-logo">
                                        ...
                                        <a href="index.html">
                                            <img class="img-fluid" src="resources/assets/images/logo.png"
                                                alt="Theme-Logo" />
                                        </a>
                                        ...
                                        <div class="pcoded-inner-navbar main-menu">
                                            ...
                                            <ul class="pcoded-item pcoded-left-item">
                                                <li class="active">
                                                    <a href="admin" class="waves-effect waves-dark">
                                                        ...
                                                        <span class="pcoded-mtext" data-i18n="nav.dash.main">Danh mục
                                                            Khoá Học</span>
                                                ...
                                                <li class="pcoded-hasmenu">
                                                    <a href="javascript:void(0)" class="waves-effect waves-dark">
                                                        ...
                                                        <span class="pcoded-mtext"
                                                            data-i18n="nav.basic-components.main">Khoá Học</span>
                                                        <span class="pcoded-mcaret"></span>
                                                    </a>
                                                    <ul class="pcoded-submenu">
                                                        <li class=" ">
                                                            <a href="course1" class="waves-effect waves-dark">
                                                                ...
                                                                <span class="pcoded-mtext"
                                                                    data-i18n="nav.basic-components.alert">Tất cả Khoá
                                                                    Học</span>
                                                                <span class="pcoded-mcaret"></span>
                                                            </a>
                                                        </li>
                                                        <li class=" ">
                                                            <a href="initInsertCourse" class="waves-effect waves-dark">
                                                                <span class="pcoded-micon"><i
                                                                        class="ti-angle-right"></i></span>
                                                                <span class="pcoded-mtext"
                                                                    data-i18n="nav.basic-components.breadcrumbs">Thêm
                                                                    Mới Khóa Học</span>
                                                                <span class="pcoded-mcaret"></span>
                                                            </a>
                                                        </li>
                                                ...
                                                <li class="pcoded-hasmenu">
                                                    <a href="javascript:void(0)" class="waves-effect waves-dark">
                                                        <span class="pcoded-micon"><i
                                                                class="ti-layout-grid2-alt"></i></span>
                                                        <span class="pcoded-mtext"
                                                            data-i18n="nav.basic-components.main">Lộ Trình Học</span>
                                                        <span class="pcoded-mcaret"></span>
                                                    </a>
                                                    <ul class="pcoded-submenu">
                                                        <li class=" ">
                                                            <a href="accordion.html" class="waves-effect waves-dark">
                                                                <span class="pcoded-micon"><i
                                                                        class="ti-angle-right"></i></span>
                                                                <span class="pcoded-mtext"
                                                                    data-i18n="nav.basic-components.alert">Tất Cả Lộ
                                                                    Trình</span>
                                                                <span class="pcoded-mcaret"></span>
                                                            </a>
                                                        </li>
                                            ...
                                            <ul class="pcoded-item pcoded-left-item">
                                                <li class="pcoded-hasmenu ">
                                                    <a href="javascript:void(0)" class="waves-effect waves-dark">
                                                        <span class="pcoded-micon"><i
                                                                class="ti-direction-alt"></i><b>M</b></span>
                                            ...
                                            <div class="col-sm-12">
												<div class="card">
													...
													<div class="page-body">
														...
														<form:form action="updateCourse" modelAttribute="c"
															method="post" enctype="multipart/form-data">
															<div class="row">
																<div class="col-md-6">
																	<div class="form-group form-default">
																		<label class="float-label">Mã Khóa Học</label>
																		<form:input class="form-control" path="couId" readonly="true"/>
																	</div>
																	<div class="form-group form-default">
																		<label class="float-label">Tên Khóa Học</label>
																		<form:input path="courseName" class="form-control"/>
																	</div>
																	<div class="form-group form-default">
																		<label class="float-label">Ảnh</label>
																		<input type="file" name="imgUrl"
																			class="form-control">
																			<img style="width:100px" src="<c:url value="resources"/>/images/${c.image}"/>
																	</div>
																...
																<div class="col-md-6">
																	...
																	<div class="form-group form-default">
																		<label class="float-label">Giá</label>
																		<form:input class="form-control" path="price"/>
																	</div>
																	<div class="form-group form-default">
																		<label class="float-label">Thời Gian Học</label>
																		<form:input path="time" class="form-control"/>

																	</div>
																	<div class="form-group form-default">
																		<label class="float-label">Mô Tả</label>
																		<form:textarea class="form-control" path="courseText"/>
																	</div>
																	<button type="submit"
																		class="btn  btn-primary mb-2">Cập Nhật</button>
