			...
			<div class="container">
				...
				<div class="row course_boxes">
					...
					<div class="col-lg-3 course_box">
						<div class="card">
							<img class="card-img-top" src="resources/images/course_6.jpg"
								alt="https://unsplash.com/@element5digital">
							<div class="card-body text-center">
								<div class="card-title">
									<a href="courses.html">Bắt đầu với .NET</a>
								</div>
							...
							<div>
								<a class="btn btn-success" href="dkonline5">Đăng Kí học</a>
							</div>
						</div>
					</div>

					<div class="col-lg-3 course_box" style="color: black;">Hỗ trợ
						nhiều ngôn ngữ lập trình: NET Framework hỗ trợ nhiều ngôn ngữ lập
						trình, cho phép lập trình viên sử dụng ngôn ngữ mà họ thích và
						hiểu quả nhất để xây dựng ứng dụng. Quản lý bộ nhớ tự động: NET
						Framework quản lý bộ nhớ cho các ứng dụng, giúp giảm tải cho lập
						trình viên và tăng tốc độ chạy của ứng dụng. Công cụ xử lý lỗi:
						NET Framework cung cấp công cụ xử lý lỗi và gỡ rối cho lập trình
						viên, giúp tìm ra và sửa các lỗi trong ứng dụng nhanh chóng. Hỗ
						trợ xây dựng ứng dụng web: NET Framework hỗ trợ xây dựng các ứng
						dụng web, bao gồm cả việc tạo giao diện người dùng và xử lý dữ
						liệu trên mạng. Hỗ trợ việc nối các ứng dụng: NET Framework cung
						cấp các công cụ và tiêu chuẩn để nối các ứng dụng với nhau, giúp
						tăng tính linh hoạt và khả năng mở rộng ứng dụng.</div>
