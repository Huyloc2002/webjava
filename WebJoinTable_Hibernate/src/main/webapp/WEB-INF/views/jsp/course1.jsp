                              ...
                              <li class="pcoded-hasmenu">
                                  ...
                                  <ul class="pcoded-submenu">
                                      ...
                                      <li class=" ">
                                       ...
                                       <li class=" ">
                                          <a href="Laravel" class="waves-effect waves-dark">
                                              <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                      ...
                                      <li class=" ">
                                          <a href="Nodejs" class="waves-effect waves-dark">
                                              <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                      ...
                      <!-- Page-header end -->
                        <div class="pcoded-inner-content">
                            ...
                            <div>
                                ...
                                <h1 Style="color: red; text-align: center;">Tất Cả Khóa Học</h1>
                                ...
                                <table style="width:100%" border="1" cellspacing="20" cellpadding="10">
									...
									<td>
										<img style="width:100px" src="<c:url value="resources"/>/images/${c.image}"/>
                                            ...
                                            <td >${c.courseText }</td>
                                         <td>   <fmt:formatNumber type ="currency">${c.price }</fmt:formatNumber></td>
                                            <td>${c.time }</td>
                                          
                                             <td ><a class="btn btn-danger" href="deleteCourse?couId=${c.couId}" onclick="return confirm('Bạn có muốn xoá không')">Delete</a></td>
                                            <td ><a class="btn btn-primary" href="initUpdateCourse?couId=${c.couId}">Sửa</a></td>
                                        </tr>
                                    </c:forEach>
