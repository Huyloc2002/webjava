                  ...
                  <div class="navbar-container container-fluid">
                      ...
                      <ul class="nav-right">
                          <li class="header-notification">
                              ...
                              <ul class="show-notification">
                                  ...
                                  <li class="waves-effect waves-light">
                                      <div class="media">
                                          <img class="d-flex align-self-center img-radius" src="resources/assets/images/img6.jpg.jpg" alt="Generic placeholder image">
                                          <div class="media-body">
                                              <h5 class="notification-user">Huy Thọ</h5>
                          ...
                          <li class="user-profile header-notification">
                              <a href="#!" class="waves-effect waves-light">
                                  <img src="resources/assets/images/img6.jpg" class="img-radius">
                                  <span>Huy Thọ</span>
                      ...
                      <div class="pcoded-inner-navbar main-menu">
                          <div class="">
                              <div class="main-menu-header">
                                  <img class="img-80 img-radius" src="resources/assets/images/img6.jpg" >
                                  <div class="user-details">
                                      <span id="more-details">Huy Thọ<i class="fa fa-caret-down"></i></span>
                                  </div>
                              </div>
                              ...
                              <div class="main-menu-content">
                                  <ul>
                                      <li class="more-details">
                                          ...
                                          <a href="login"><i class="ti-layout-sidebar-left"></i>Logout</a>
                                      </li>
                                  </ul>
                              </div>
                          </div>
                      ...
                      <!-- Page-header end -->
                        <div class="pcoded-inner-content">
                            ...
                            <div>
												...
												<h1 Style="color: red; text-align: center;">QUẢN TRỊ VIÊN</h1>
												<a class="btn btn-success" href="initInsertStudent">Thêm Mới</a>
												<form action="searchByName">
													<p>Tìm Kiếm Theo tên:</p>
													<input style="width: 30%; height: 40px;" type="text"
														name="studentName" /> <input class="btn btn-info" type="submit"
														value="Search" />
												</form>
												...
												<c:if test="${not empty list }">
													...
													<table style="width: 100%" border="1" cellspacing="20"
														cellpadding="10">
														<tr>
															<th>Id</th>
															<th>Tên</th>
														...
														<c:forEach items="${list }" var="s">
															<tr>
																...
																<td><img style="width: 50px" src="<c:url value="
																		resources" />/images/${s.image}" /></td>

																<td>${s.gender?"nam":"nữ" }</td>
																<td>${s.email }</td>
																<td>
																	<fmt:formatDate value="${s.dateofBirth }"
																		pattern="dd/MM/yyyy" />
																</td>
																<td>${s.address }</td>
																<td>${s.phoneNumber }</td>
																<td>${s.course.courseName}</td>
																<td>${s.dateregistration }</td>
																<td>${s.gender?"hết hạn":"chưa hết hạn" }</td>
																<td><a class="btn btn-danger"
																		href="deleteStudent?studentId=${s.studentId}"
																		onclick="return confirm('Bạn có muốn xoá không')">x</a>
																</td>
																<td><a class="btn btn-primary"
																		href="initUpdateStudent?studentId=${s.studentId}"
																		onclick="return confirm('Bạn có muốn sửa không')"><i class="fa fa-pencil" aria-hidden="true"></i></a>
																</td>
															</tr>
														</c:forEach>
													</table>
