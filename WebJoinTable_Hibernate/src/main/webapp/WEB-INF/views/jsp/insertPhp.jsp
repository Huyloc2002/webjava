							...
							<div class="col-sm-12">
								<div class="card">
									...
									<div class="page-body">
										...
										<form:form action="insertPhp" modelAttribute="p"
											method="post" enctype="multipart/form-data">
											<div class="row">
												<div class="col-md-6">
													<div class="form-group form-default">
														<label class="float-label">Mã Khóa Học</label> <input
															type="text" name="phpId" class="form-control"> <span
															class="form-bar"></span>
														<form:errors path="phpId" cssClass="error"></form:errors>
														<br>
													</div>
														<div class="form-group form-default">
														<label class="float-label">Tên </label> <input
															type="text" name="student.studentId" class="form-control">
													...
													<div class="form-group form-default">
														<label class="float-label">Tên Khóa Học</label> <input
															type="text" name="courseText" class="form-control">
														<span class="form-bar"></span>
												...
												<div class="col-md-6">
													...
													<div class="form-group form-default">
														<label class="float-label">Giá</label> <input type="text"
													...
													<div class="form-group form-default">
														<label class="float-label">Thời Gian Học</label> <input
															type="text" name="time" class="form-control"> <span
															class="form-bar"></span>
