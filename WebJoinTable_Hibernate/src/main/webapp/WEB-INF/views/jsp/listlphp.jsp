                              ...
                              <li class="pcoded-hasmenu">
                                  ...
                                  <ul class="pcoded-submenu">
                                      ...
                                      <li class=" ">
                                       ...
                                       <li class=" ">
                                          <a href="listjava" class="waves-effect waves-dark">
                                              <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                      ...
                      <!-- Page-header end -->
                        <div class="pcoded-inner-content">
                            ...
                            <div>
                                ...
                                <h1 Style="color: red; text-align: center;">Khoá Học PHP</h1>
                                  	<a class="btn btn-success" href="initInsertPhp">Thêm Mới</a>
